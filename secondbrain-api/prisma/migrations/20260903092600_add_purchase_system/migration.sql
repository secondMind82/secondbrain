...
-- AddForeignKey
ALTER TABLE "public"."Purchase" ADD CONSTRAINT "Purchase_entityId_fkey" FOREIGN KEY ("entityId") REFERENCES "public"."Entity"("id") ON DELETE CASCADE ON UPDATE CASCADE;
